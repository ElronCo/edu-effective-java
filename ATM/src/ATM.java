...
public class ATM {
	...
	private final DepositSlot depositSlot; // ATM's deposit slot
	...
	private void performTransactions() {
		...
		while (!userExited) {
			...
			MenuOptions mainMenuSelection = displayMainMenu();
	...
	private MenuOptions displayMainMenu() {
		screen.displayMessageLine("\nMain menu:");
		...
		int input = keypad.getInput(); // return user's selection
		return MenuOptions.findOption(input);
	} // end method displayMainMenu

	// return object of specified Transaction subclass
	private Transaction createTransaction(MenuOptions type) {
